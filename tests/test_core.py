...
class TestClaudeCodeFormatter:
    ...
    def test_format_export_command(self):
        ...
        assert 'export ANTHROPIC_MODEL=us.anthropic.claude-sonnet-4-20250514-v1:0' in result
        assert 'export ANTHROPIC_SMALL_FAST_MODEL=us.anthropic.claude-sonnet-4-20250514-v1:0' in result
    ...
    def test_format_json_output(self):
        ...
        assert claude_config['primary_model'] == 'us.anthropic.claude-sonnet-4-20250514-v1:0'
        assert claude_config['fast_model'] == 'us.anthropic.claude-sonnet-4-20250514-v1:0'
